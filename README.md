...
- [dsh-chat-import](https://github.com/devmom/dsh-session-import) - Cross-tool session migration: import full-fidelity conversations from 15+ agents (Codex / Claude Code / Kimi Code / ZCode / OpenClaw / WorkBuddy / Gemini / Cursor / Aider / Continue / OpenCode / ChatGPT / generic JSON) as resumable dsh sessions, with titles preserved, workspace binding, browser multi-select import wizard, model tools, privacy redaction and knowledge extraction (npm: chat-import).
